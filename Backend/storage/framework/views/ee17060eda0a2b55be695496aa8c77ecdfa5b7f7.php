...
} elseif ($_instance->childHasBeenRendered('pxnXMR3')) {
    $componentId = $_instance->getRenderedChildComponentId('pxnXMR3');
    $componentTag = $_instance->getRenderedChildComponentTagName('pxnXMR3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('pxnXMR3');
} else {
    $response = \Livewire\Livewire::mount('tables.menu-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('pxnXMR3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /Users/ambrosetemidayobako/Dev/web/fuodz-admin/resources/views/livewire/menu.blade.php ENDPATH**/ ?>