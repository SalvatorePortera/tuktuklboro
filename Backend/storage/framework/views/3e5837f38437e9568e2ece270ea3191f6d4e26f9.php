...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['class' => 'w-8 h-8 text-primary-500']); ?>
...
<?php endif; ?>
                                ...
                                <p><span class="my-2 text-2xl font-semibold"><?php echo e(__(('Want to Partner with us?'))); ?></span> <br /><a href="<?php echo e(route('register')); ?>" class="ml-2 font-bold text-primary-500 text-md"><?php echo e(__(('Click here'))); ?></a></p>
                            </div>
...
<?php /**PATH /Users/ambrosetemidayobako/Dev/web/fuodz-admin/resources/views/livewire/auth/login.blade.php ENDPATH**/ ?>