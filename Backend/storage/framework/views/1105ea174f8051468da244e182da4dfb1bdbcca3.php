...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('5z55WCR')) {
    $componentId = $_instance->getRenderedChildComponentId('5z55WCR');
    $componentTag = $_instance->getRenderedChildComponentTagName('5z55WCR');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5z55WCR');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('5z55WCR', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
</div><?php /**PATH /Users/ambrosetemidayobako/Dev/web/fuodz-admin/resources/views/livewire/edit-order.blade.php ENDPATH**/ ?>