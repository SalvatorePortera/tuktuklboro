...
} elseif ($_instance->childHasBeenRendered('xnd6NOP')) {
    $componentId = $_instance->getRenderedChildComponentId('xnd6NOP');
    $componentTag = $_instance->getRenderedChildComponentTagName('xnd6NOP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('xnd6NOP');
} else {
    $response = \Livewire\Livewire::mount('tables.order-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('xnd6NOP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('SGNLNXO')) {
    $componentId = $_instance->getRenderedChildComponentId('SGNLNXO');
    $componentTag = $_instance->getRenderedChildComponentTagName('SGNLNXO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('SGNLNXO');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('SGNLNXO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('yJgNyDm')) {
    $componentId = $_instance->getRenderedChildComponentId('yJgNyDm');
    $componentTag = $_instance->getRenderedChildComponentTagName('yJgNyDm');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('yJgNyDm');
} else {
    $response = \Livewire\Livewire::mount('edit-order-livewire');
    $html = $response->html();
    $_instance->logRenderedChild('yJgNyDm', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('lmPyTQ1')) {
    $componentId = $_instance->getRenderedChildComponentId('lmPyTQ1');
    $componentTag = $_instance->getRenderedChildComponentTagName('lmPyTQ1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('lmPyTQ1');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('lmPyTQ1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('yQOCQYC')) {
    $componentId = $_instance->getRenderedChildComponentId('yQOCQYC');
    $componentTag = $_instance->getRenderedChildComponentTagName('yQOCQYC');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('yQOCQYC');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('yQOCQYC', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('az9nkz1')) {
    $componentId = $_instance->getRenderedChildComponentId('az9nkz1');
    $componentTag = $_instance->getRenderedChildComponentTagName('az9nkz1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('az9nkz1');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('az9nkz1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('5vYxopn')) {
    $componentId = $_instance->getRenderedChildComponentId('5vYxopn');
    $componentTag = $_instance->getRenderedChildComponentTagName('5vYxopn');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5vYxopn');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('5vYxopn', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            <?php endif; ?>
...
<?php /**PATH /Users/ambrosetemidayobako/Dev/web/fuodz-admin/resources/views/livewire/orders.blade.php ENDPATH**/ ?>