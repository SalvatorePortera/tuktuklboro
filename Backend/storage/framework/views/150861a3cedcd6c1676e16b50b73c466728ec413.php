...
<?php endif; ?>
        ...
        <form wire:submit.prevent="<?php echo e($action ?? ''); ?>">
            <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4 <?php echo e(setting('localeCode') == 'ar' ? 'text-right':'text-left'); ?>">
                <?php echo e($slot); ?>
...
<?php /**PATH /Users/ambrosetemidayobako/Dev/web/fuodz-admin/resources/views/components/modal-lg.blade.php ENDPATH**/ ?>