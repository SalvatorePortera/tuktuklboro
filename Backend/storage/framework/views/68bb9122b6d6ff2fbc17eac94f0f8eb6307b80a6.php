            ...
            <ul class="flex items-center flex-shrink-0 space-x-6 ltr:ml-auto rtl:mr-auto">
                ...
                <li class="relative">
                    <button class="flex items-center align-middle focus:outline-none" @click="toggleProfileMenu"
                        ...
                        <img class="object-cover w-8 h-8 <?php echo e(setting('localeCode') == 'ar' ? 'ml-2':'mr-2'); ?> rounded-full" src="<?php echo e(Auth::user()->photo); ?>" alt=""
                            aria-hidden="true" />
...
<?php /**PATH /Users/ambrosetemidayobako/Dev/web/fuodz-admin/resources/views/livewire/header/profile.blade.php ENDPATH**/ ?>