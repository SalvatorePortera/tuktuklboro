...
$message = $__bag->first($__errorArgs[0]); ?>
            <div class="mt-1 text-xs text-red-700 text-center"><?php echo e($message); ?></div>
            <?php unset($message);
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
        <div class="mt-4 text-xs text-red-700 text-center"><?php echo e($message); ?></div>
        <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
    ...
    <?php else: ?>
    <?php echo $__env->make('envato-purchase-code-verifier::components.verified', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>
</div>
<?php /**PATH /Users/ambrosetemidayobako/Dev/web/fuodz-admin/vendor/ambrosethebuild/envato-purchase-code-verifier/src/Providers/../../resources/views/livewire/verify-component.blade.php ENDPATH**/ ?>