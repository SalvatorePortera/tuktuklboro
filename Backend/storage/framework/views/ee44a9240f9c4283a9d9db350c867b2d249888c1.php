...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.baseview','data' => ['title' => ''.e(__('Driver Remittance')).'']]); ?>
...
} elseif ($_instance->childHasBeenRendered('jcZH8hA')) {
    $componentId = $_instance->getRenderedChildComponentId('jcZH8hA');
    $componentTag = $_instance->getRenderedChildComponentTagName('jcZH8hA');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('jcZH8hA');
} else {
    $response = \Livewire\Livewire::mount('tables.remittance-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('jcZH8hA', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
    ...
    <div x-data="{ open: <?php if ((object) ('showCreate') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($_instance->id); ?>').entangle('<?php echo e('showCreate'->value()); ?>')<?php echo e('showCreate'->hasModifier('defer') ? '.defer' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($_instance->id); ?>').entangle('<?php echo e('showCreate'); ?>')<?php endif; ?> }">
        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.modal','data' => ['confirmText' => ''.e(__('Driver Remittance')).'','action' => 'collect']]); ?>
...
<?php $component->withAttributes(['confirmText' => ''.e(__('Driver Remittance')).'','action' => 'collect']); ?>
            ...
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.select','data' => ['title' => ''.e(__('Staus')).'','options' => ['Collected','Cancelled'],'name' => 'status','defer' => true]]); ?>
...
<?php endif; ?>
                ...
                <?php if($selectedModel != null && $selectedModel->vendor != null && $selectedModel->vendor->vendor_type != null && $selectedModel->vendor->vendor_type->is_parcel ?? false ): ?>
                    <?php if(!empty($selectedModel->delivery_address)): ?>
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.details.item','data' => ['title' => ''.e(__('Delivery Address')).'','text' => ''.e($selectedModel->delivery_address->address ?? '').'']]); ?>
<?php $component->withName('details.item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
            ...
            <?php if($selectedModel != null && $selectedModel->vendor != null && $selectedModel->vendor->vendor_type != null && $selectedModel->vendor->vendor_type->is_parcel ?? false ): ?>
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <?php $__currentLoopData = $selectedModel->stops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $stop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.details.item','data' => ['title' => ''.e(__('Stop')).' '.e($key + 1).'','text' => ''.e($stop->delivery_address->address ?? '').'']]); ?>
<?php $component->withName('details.item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php endif; ?>
                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.details.item','data' => ['title' => ''.e(__('Recipient')).'']]); ?>
<?php $component->withName('details.item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php endif; ?>
                ...
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.details.item','data' => ['title' => ''.e(__('Date of order')).'','text' => ''.e($selectedModel->formatted_date ?? '').'']]); ?>
<?php $component->withName('details.item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php endif; ?>
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.details.item','data' => ['title' => ''.e(__('Updated At')).'','text' => ''.e($selectedModel->updated_at ?? '--').'']]); ?>
<?php $component->withName('details.item'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php endif; ?>
            ...
            <?php if($selectedModel != null && $selectedModel->vendor->vendor_type->is_parcel ?? false): ?>
                <div class="pt-4 mt-4 border-t ">
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.order.package','data' => ['order' => $selectedModel ?? '']]); ?>
...
<?php /**PATH /Users/ambrosetemidayobako/Dev/web/fuodz-admin/resources/views/livewire/remittance.blade.php ENDPATH**/ ?>