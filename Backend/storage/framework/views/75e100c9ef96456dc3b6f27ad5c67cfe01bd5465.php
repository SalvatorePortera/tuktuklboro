...
<?php $component->withAttributes([]); ?>
            <p class="py-4 text-xl font-bold border-b"><?php echo e(__('Categories')); ?></p>
...
<?php endif; ?>
            ...
            <div class="p-4 max-h-65vh products-list-view">
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div class="text-center border rounded shadow cursor-pointer hover:shadow-md <?php echo e($category->id == $selectedItemId ? 'bg-primary-200':''); ?>" wire:click="itemSelected('<?php echo e($category->id); ?>')">
                        <img src="<?php echo e($category->photo); ?>" class="w-full h-12" />
                        <div class="p-2">
                            <p class="text-sm font-semibold break-words"><?php echo e($category->name); ?></p>
                            <p class="text-xs"> <?php echo e(__("Products")); ?>: <span class="text-xs font-bold"><?php echo e($category->products_count); ?></span></p>
                        </div>
                    </div>
...
<?php /**PATH /Users/ambrosetemidayobako/Dev/web/fuodz-admin/resources/views/livewire/extensions/pos/pos-category-selection-modal.blade.php ENDPATH**/ ?>