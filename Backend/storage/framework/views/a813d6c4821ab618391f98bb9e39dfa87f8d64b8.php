<?php if($model->amount > 0): ?>
    <button
        ...
        wire:click="$emit('initiatePayout', <?php echo e($model->id); ?> )" title="<?php echo e(__('Payout')); ?>">
...
<?php endif; ?> <?php echo e(__('Payout')); ?>

    </button>
<?php else: ?>
    <p class="text-sm italic text-gray-400"><?php echo e(__('Nothinng to Payout')); ?></p>
<?php endif; ?>
<?php /**PATH /Users/ambrosetemidayobako/Dev/web/fuodz-admin/resources/views/components/buttons/payout.blade.php ENDPATH**/ ?>