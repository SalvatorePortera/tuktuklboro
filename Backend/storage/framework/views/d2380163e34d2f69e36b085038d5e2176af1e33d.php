...
} elseif ($_instance->childHasBeenRendered('XGHZSvV')) {
    $componentId = $_instance->getRenderedChildComponentId('XGHZSvV');
    $componentTag = $_instance->getRenderedChildComponentTagName('XGHZSvV');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('XGHZSvV');
} else {
    $response = \Livewire\Livewire::mount('tables.product-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('XGHZSvV', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
            ...
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('component.multiple-media-upload', ['title' => ''.e(__('Image')).'','name' => 'photos','types' => 'PNG or JPEG','fileTypes' => 'image/*','emitFunction' => 'photoSelected'])->html();
} elseif ($_instance->childHasBeenRendered('4eiirOe')) {
    $componentId = $_instance->getRenderedChildComponentId('4eiirOe');
    $componentTag = $_instance->getRenderedChildComponentTagName('4eiirOe');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('4eiirOe');
} else {
    $response = \Livewire\Livewire::mount('component.multiple-media-upload', ['title' => ''.e(__('Image')).'','name' => 'photos','types' => 'PNG or JPEG','fileTypes' => 'image/*','emitFunction' => 'photoSelected']);
    $html = $response->html();
    $_instance->logRenderedChild('4eiirOe', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('rfNglnm')) {
    $componentId = $_instance->getRenderedChildComponentId('rfNglnm');
    $componentTag = $_instance->getRenderedChildComponentTagName('rfNglnm');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('rfNglnm');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('rfNglnm', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
...
} elseif ($_instance->childHasBeenRendered('bI8ZBiH')) {
    $componentId = $_instance->getRenderedChildComponentId('bI8ZBiH');
    $componentTag = $_instance->getRenderedChildComponentTagName('bI8ZBiH');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('bI8ZBiH');
} else {
    ...
    $html = $response->html();
    $_instance->logRenderedChild('bI8ZBiH', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
            ...
            <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('component.multiple-media-upload', ['title' => ''.e(__('Image')).'','name' => 'photos','types' => 'PNG or JPEG','fileTypes' => 'image/*','emitFunction' => 'photoSelected','preview' => $photos])->html();
} elseif ($_instance->childHasBeenRendered('1d3BFgE')) {
    $componentId = $_instance->getRenderedChildComponentId('1d3BFgE');
    $componentTag = $_instance->getRenderedChildComponentTagName('1d3BFgE');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('1d3BFgE');
} else {
    $response = \Livewire\Livewire::mount('component.multiple-media-upload', ['title' => ''.e(__('Image')).'','name' => 'photos','types' => 'PNG or JPEG','fileTypes' => 'image/*','emitFunction' => 'photoSelected','preview' => $photos]);
    $html = $response->html();
    $_instance->logRenderedChild('1d3BFgE', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('component.autocomplete-input', ['title' => ''.e(__('Vendor')).'','column' => 'name','model' => 'Vendor','emitFunction' => 'autocompleteVendorSelected','initialEmit' => 'preselectedVendorEmit','disable' => ''.e(auth()->user()->hasRole('manager') ?? 'false').''])->html();
} elseif ($_instance->childHasBeenRendered('h4khjLx')) {
    $componentId = $_instance->getRenderedChildComponentId('h4khjLx');
    $componentTag = $_instance->getRenderedChildComponentTagName('h4khjLx');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('h4khjLx');
} else {
    $response = \Livewire\Livewire::mount('component.autocomplete-input', ['title' => ''.e(__('Vendor')).'','column' => 'name','model' => 'Vendor','emitFunction' => 'autocompleteVendorSelected','initialEmit' => 'preselectedVendorEmit','disable' => ''.e(auth()->user()->hasRole('manager') ?? 'false').'']);
    $html = $response->html();
    $_instance->logRenderedChild('h4khjLx', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('component.autocomplete-input', ['title' => ''.e(__('Categories')).'','column' => 'name','model' => 'Category','emitFunction' => 'autocompleteCategorySelected','updateQueryClauseName' => 'categoryQueryClasueUpdate','clear' => true,'queryClause' => $categorySearchClause ?? '','onclearCalled' => 'clearAutocompleteFieldsEvent'])->html();
} elseif ($_instance->childHasBeenRendered('c2O7z16')) {
    $componentId = $_instance->getRenderedChildComponentId('c2O7z16');
    $componentTag = $_instance->getRenderedChildComponentTagName('c2O7z16');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('c2O7z16');
} else {
    $response = \Livewire\Livewire::mount('component.autocomplete-input', ['title' => ''.e(__('Categories')).'','column' => 'name','model' => 'Category','emitFunction' => 'autocompleteCategorySelected','updateQueryClauseName' => 'categoryQueryClasueUpdate','clear' => true,'queryClause' => $categorySearchClause ?? '','onclearCalled' => 'clearAutocompleteFieldsEvent']);
    $html = $response->html();
    $_instance->logRenderedChild('c2O7z16', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /Users/ambrosetemidayobako/Dev/web/fuodz-admin/resources/views/livewire/products.blade.php ENDPATH**/ ?>