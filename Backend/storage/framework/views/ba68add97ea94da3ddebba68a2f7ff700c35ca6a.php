...
} elseif ($_instance->childHasBeenRendered('ID0kBYy')) {
    $componentId = $_instance->getRenderedChildComponentId('ID0kBYy');
    $componentTag = $_instance->getRenderedChildComponentTagName('ID0kBYy');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ID0kBYy');
} else {
    $response = \Livewire\Livewire::mount('tables.user-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('ID0kBYy', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /Users/ambrosetemidayobako/Dev/web/fuodz-admin/resources/views/livewire/users.blade.php ENDPATH**/ ?>