...
<li class="relative px-6 py-3">
    ...
    <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-200 <?php echo e($isActive ? 'text-white' : 'text-gray-200'); ?>"
        ...
        <span class="<?php echo e(setting('localeCode') == 'ar' ? 'mr-4':'ml-4'); ?>"><?php echo e($title); ?></span>
    </a>


</li>
<?php /**PATH /Users/ambrosetemidayobako/Dev/web/fuodz-admin/resources/views/components/menu-item.blade.php ENDPATH**/ ?>