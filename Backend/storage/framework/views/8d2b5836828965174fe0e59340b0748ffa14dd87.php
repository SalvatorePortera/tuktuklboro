...
} elseif ($_instance->childHasBeenRendered('9kdBj6f')) {
    $componentId = $_instance->getRenderedChildComponentId('9kdBj6f');
    $componentTag = $_instance->getRenderedChildComponentTagName('9kdBj6f');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('9kdBj6f');
} else {
    $response = \Livewire\Livewire::mount('component.dynamic-nav-menu', []);
    $html = $response->html();
    $_instance->logRenderedChild('9kdBj6f', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /Users/ambrosetemidayobako/Dev/web/fuodz-admin/resources/views/layouts/partials/nav/menu.blade.php ENDPATH**/ ?>